...
import TokenLocker from './TokenLocker.jsx';
import LpLocker from './LpLocker.jsx';
...
export const routeConfig = [
  ...
  { path: '/airdrops',       label: 'Airdrop',         Component: Airdrop },
  { path: '/token-locker',   label: 'Token Locker',    Component: TokenLocker },
  { path: '/lp-locker',      label: 'LP Locker',       Component: LpLocker },
