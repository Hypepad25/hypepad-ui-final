    ...
    <nav className="w-full flex items-center justify-between px-6 py-4 bg-black">
      <div className="flex items-center gap-3">
        ...
        <div className="hidden md:flex gap-6 overflow-x-auto whitespace-nowrap">
          ...
          <Link to="/token-creator" className="text-base font-medium text-white hover:text-orange-400">Token Creator</Link>
          <Link to="/meme-launcher" className="text-base font-medium text-white hover:text-orange-400">Meme Launcher</Link>
